...
public class TestDataLoader {
    ...
    @Autowired
    public TestDataLoader(UserRepository userRepository, ArticleRepository articleRepository) {
    ...
    public void loadData() {
        ...
        String[] names = {"Igor", "Ellen", "John", "Nazar"};
        int[] ages = {24, 24, 53, 14};
        String[] nations = {"USA", "Canada", "UK", "German"};
